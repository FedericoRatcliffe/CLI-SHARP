...
using SharpTerminal.Infrastructure.ConPty;
using SharpTerminal.UI.Config;
using SharpTerminal.UI.AI;
using SharpTerminal.UI.Controls;
using SharpTerminal.UI.Layout;
using TerminalFontMetrics = SharpTerminal.UI.Rendering.FontMetrics;

namespace SharpTerminal.UI.Views;
...
public partial class MainWindow : Window
{
    ...
    private void CreateNewTab()
    {
        ...
        catch (Exception ex) { Title = $"SharpTerminal — Error: {ex.Message}"; }
    }
